                ...
                <form className="form" onSubmit={handleSubmit}>
                  ...
                  {type === "addUser" && (
                    <div className="form-group">
                      ...
                      <div className="password">
                        ...
                        />
                        <span onClick={handleDisplayPass}>
                          {hidePass ? (
                  ...
                  <div className="form-group">
                    ...
                    <div className="gender">
                      <Field name="role" value="ADMIN" type="radio" />
                      ADMIN
                      <Field name="role" value="USER" type="radio" />
                      USER
                    </div>
                  </div>
                  ...
                  <div className="form-button">
                    <button type="submit" className="login-button">
                      {type === "addUser" ? "Thêm người dùng" : "cập nhập"}
                    </button>
                  </div>
                </form>
              )}
