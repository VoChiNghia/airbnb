...
import {
  deleteBookRoom,
  getBookRoomByUserApi,
} from "../../redux/bookRoomReducer";
  ...
  return (
    <div className="trip container">
      <div className="trip__container">
        ...
        <hr />
        {trip.length !== 0 ? (
          <div className="trip__container__wrapper">
            <div className="left">
              {trip?.map((item: Room, index: number) => (
                <div className="trip__item" key={index}>
                  ...
                  <button onClick={() => handleDelete(Number(item.roomId))}>
                    Delete
                  </button>
                </div>
              ))}
