...
import { BiHeart, BiMessageMinus, BiArrowBack } from "react-icons/bi";
import {
  BsWater,
  BsChevronDown,
  BsTranslate,
...
const Detail = (props: Props) => {
  ...
  const handleSave = () => {
    dispatch(
      changeComponent(
        <Save maPhong={Number(param.id)} img={roomById?.hinhAnh} />
      )
    );
    dispatch(setIsOpen(true));
  };
      ...
      {loading ? (
        ...
        <div className="detail container">
          ...
          <div className="detail__body">
            <div className="detail__body-left">
              ...
              <div className="translate-desc">
                ...
                <p>
                  ...
                  trọn cuộc đời chăm sóc 4 đứa con gái của mình và yêu thương
                  người vợ đã ở trên cánh đồng lúa suốt những ngày dài để mang
                  lại thức ăn tinh khiết cho con cái. Nhà tôi nằm ở làng Thanh
                  Hà yên bình được bao bọc bởi dòng sông Thu Bồn nổi tiếng và
                  những cánh đồng xanh vô tận. Biệt thự CON trai có 7 căn hộ ở 2
                  khu vực khác nhau nhìn ra hồ bơi tuyệt vời và những cánh đồng.
                </p>
                ...
                <div>
                  <ul>
                    ...
                    <li>
                      ...
                      {roomById?.doXe ? "Chỗ đỗ xe miễn phí" : "không có"}
                    </li>
                    <li>
                      <BsSnow className="icon" />{" "}
                      {roomById?.dieuHoa ? "Điều hòa nhiệt độ" : "không có"}
                    </li>
                    <li>
                      <MdOutlineIron className="icon" />{" "}
                      {roomById?.banLa ? "Bàn là" : "không có"}
                    </li>
                  </ul>
                  <ul>
                    <li>
                      <BsWifi className="icon" />{" "}
                      {roomById?.wifi ? "Wifi" : "không có"}
                    </li>
                    <li>
                      <TbPool className="icon" />{" "}
                      {roomById?.hoBoi ? "Hồ Bơi" : "không có"}
                    </li>
                    <li>
                      <TiVideoOutline className="icon" /> Camera an ninh trong
                      nhà
                    </li>
                    <li>
                      <MdOutlineBedroomParent className="icon" />{" "}
                      {roomById?.phongNgu ? "Phòng ngủ" : "không có"}
                    </li>
                  </ul>
                </div>

                <div className="feature-display">
                  <button onClick={handleDisplayAllFeature}>
                    {t("content.allfeature")}
                  </button>
                </div>
              </div>
            ...
            <div className="detail__body-right">
              <div className="detail__body-right-wrapper">
                ...
                <div className="date">
                  ...
                  <div className="date__bottom" onClick={handleClickSubmenu}>
                    <div>
                      <p>Khách</p>
                      <span>
                        {customers.adult} khách, {customers.baby} em bé,{" "}
                        {customers.children} trẻ em
                      </span>
                    </div>
                    <div>
                      <BsChevronDown />
                ...
                <button className="checkRoom" onClick={handleSubmit}>
                  {t("content.bookroom")}
                </button>
          ...
          <div className="detail__review">
            <div className="detail__review-header">
              <h1>
                ...
                {getComment.length == 0 ? "Chưa có" : getComment.length} đánh
                giá
              </h1>
            ...
            <div className="post-comment">
              ...
              <textarea
                ...
                onChange={(e) => (commentInput.current = e.target.value)}
              ></textarea>
          ...
          <DetailMobileBottom
            ...
            price={
              Number(roomById?.giaTien) * Number(endDateFormat.split("/")[0]) -
              Number(startDateFormat.split("/")[0])
            }
